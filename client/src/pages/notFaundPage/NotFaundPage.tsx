    ...
    return (
        <div className="flex h-[calc(100vh-80px)] items-center justify-center p-5 w-full bg-white">
            <div className="text-center">
                ...
                <h1 className="mt-5 text-[36px] font-bold text-slate-800 lg:text-[50px]">500 - страница не найдена</h1>
                <p className="text-slate-600 mt-5 lg:text-lg">Упс! Что-то пошло не так. Попробуйте обновить эту страницу или свяжитесь с нами, если проблема не исчезнет.</p>
            </div>
        </div>
    )
}
