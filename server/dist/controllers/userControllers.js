    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                ...
                if (existingUser)
                    return [2 /*return*/, next((0, http_errors_1.default)(422, "Электронная почта уже существует!"))];
            ...
            case 4:
                _b.sent();
                res.json({ message: "Создано пользователем" });
                return [3 /*break*/, 6];
            case 5:
                error_1 = _b.sent();
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 2:
                user = _b.sent();
                if (!user)
                    return [2 /*return*/, next((0, http_errors_1.default)(404, "Пользователь не найден!"))];
                if (!user.isUserVerified)
                    return [2 /*return*/, next((0, http_errors_1.default)(406, "Пользователь не проверен"))];
                return [4 /*yield*/, bcrypt_1.default.compare(password, user.password)];
            case 3:
                isValidPassword = _b.sent();
                if (!isValidPassword)
                    return [2 /*return*/, next((0, http_errors_1.default)(401, "\n" +
                            "Неверный пароль!"))];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                user = _a.sent();
                if (!user)
                    return [2 /*return*/, next((0, http_errors_1.default)(404, "\n" +
                            "Электронная почта недействительна!"))];
                if (user.isUserVerified)
                    return [2 /*return*/, next((0, http_errors_1.default)(406, "Пользователь уже проверен"))];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                user = _a.sent();
                if (!user)
                    return [2 /*return*/, next((0, http_errors_1.default)(401, "Токен недействителен"))];
            ...
            case 3:
                _a.sent();
                res.json({ message: "Электронная почта проверена!" });
                return [3 /*break*/, 5];
            case 4:
                error_4 = _a.sent();
                return [2 /*return*/, next((0, http_errors_1.default)(401, "Токен недействителен"))];
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                user = _a.sent();
                if (!user)
                    return [2 /*return*/, next((0, http_errors_1.default)(404, "Электронная почта недействительна!"))];
                return [4 /*yield*/, bcrypt_1.default.hash(user._id.toString(), 8)];
            case 3:
                encryptedToken = _a.sent();
                jwtToken = jsonwebtoken_1.default.sign({ userId: user._id }, config_1.JWT_KEY, {
